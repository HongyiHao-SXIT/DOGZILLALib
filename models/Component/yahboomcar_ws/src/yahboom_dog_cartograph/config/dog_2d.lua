...
options = {
  ...
  tracking_frame = "imu_link",--算法跟踪的坐标系名称
  published_frame = "base_footprint",--发布位姿的坐标系名称
  odom_frame = "odom",--里程计坐标系名称（仅在provide_odom_frame为true时使用）
  provide_odom_frame = true,--是否提供里程坐标系
...
MAP_BUILDER.pose_graph.constraint_builder.log_matches = true --是否打开匹配日志输出 default=true
