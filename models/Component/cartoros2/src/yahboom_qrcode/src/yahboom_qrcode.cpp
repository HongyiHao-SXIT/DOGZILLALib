...
//        publisher_contours_image ->publish(compressed_image_contours);
    ...
    std::string detect_prototxt = "/home/pi/cartographer_ws2/detect.prototxt";
    std::string detect_caffe_model = "/home/pi/cartographer_ws2/detect.caffemodel";
    std::string sr_prototxt = "/home/pi/cartographer_ws2/sr.prototxt";
    std::string sr_caffe_model = "/home/pi/cartographer_ws2/sr.caffemodel";
    cv::String calibPath = "/home/pi/cartographer_ws2/ost.yaml";
    double fov_h, fov_v;
