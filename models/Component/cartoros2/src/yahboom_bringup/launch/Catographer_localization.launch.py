...
def generate_launch_description():
    ...
    load_state_filename = LaunchConfiguration('load_state_filename', default='/home/yahboom/cartoros2/data/maps/mymap2.pbstream')
    print("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$")
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            remappings=[('/scan', '/scan'),('/imu', '/imu/data_raw_self')]),
