...
def generate_launch_description():
  ...
  #指定路径
  default_xacro_model_path = os.path.join(get_package_share_directory('yahboom_description'), 'urdf/', 'xgo_rviz.xacro') 
  default_rviz_config_path = os.path.join(get_package_share_directory('yahboom_config'), 'config/rviz2/', 'xgo.rviz') 
