...
class Dogzilla_Joystick(object):
    ...
    def __init__(self, dog:DOGZILLA, js_id=0, debug=False):
        self.__debug = debug
    ...
    def __data_processing(self, name, value):
        if name=="RK1_LEFT_RIGHT":
            ...
            if value == 0:
                ...
                fvalue = int(self.__my_map(self.__step_control, 20, 100, 30, self.__STEP_SCALE_Z*100))*value
            ...
            if self.__debug:
                print (name, ":", value)
            if value == 1 and self.__pace_freq > 1:
